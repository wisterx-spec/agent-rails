...
- **开发前端** → 强制阅读 `.agents/rules/frontend-ui.md` 中关于禁用色彩和组件约束的规定
- **修改数据库表** → 强制阅读 `.agents/rules/db.md` 中的建模死记硬背条款

### 3. 🔍 变更影响预判 (Impact Analysis - Conditional)
...
### 4. 📝 测试骨架优先 (Test-First Skeleton - Layered)
根据改动类型，决定是否先写测试骨架：
